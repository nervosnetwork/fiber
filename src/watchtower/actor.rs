...
use ckb_sdk::{
    rpc::ckb_indexer::{Cell, CellType, Order, ScriptType, SearchKey, SearchMode, Tx, TxWithCell},
...
fn handle_transaction<S: InvoiceStore>(
...
fn process_commitment_tx<S: InvoiceStore>(
    ckb_client: &CkbRpcClient,
    cell_collector: &mut DefaultCellCollector,
    channel_data: &ChannelData,
    tx: Transaction,
...
fn handle_revocation<S: InvoiceStore>(
    ckb_client: &CkbRpcClient,
    cell_collector: &mut DefaultCellCollector,
    channel_data: &ChannelData,
    tx: Transaction,
