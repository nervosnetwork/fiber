...
/// The expiry delta to forward a tlc, in milliseconds, default to 8 hour.
pub const DEFAULT_TLC_EXPIRY_DELTA: u64 = 8 * 60 * 60 * 1000;
...
/// The maximum expiry delta for a payment, in milliseconds. 5 days
pub const MAX_PAYMENT_TLC_EXPIRY_LIMIT: u64 = 5 * 24 * 60 * 60 * 1000; // 5 days
