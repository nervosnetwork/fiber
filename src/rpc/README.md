...
* `final_tlc_expiry_delta` - `Option<u64>`, the htlc expiry delta should be used to set the timelock for the final hop, in milliseconds
* `tlc_expiry_limit` - `Option<u64>`, the htlc expiry limit for the whole payment, in milliseconds
