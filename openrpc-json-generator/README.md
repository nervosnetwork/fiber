...
This crate used a modified version of `openrpsee`. So it's bundled in this directory. It's not directly integrated into `openrpc-json-generator` because both `openrpc-json-generator` and it's build script depends on `openrpsee`.
