    ...
    fn samples(seed: u64) -> Vec<Self> {
        vec![
            ...
            ChannelData {
                ...
                local_settlement_key: Some(deterministic_privkey(seed, 1)),
            ...
            ChannelData {
                ...
                funding_udt_type_script: None,
                local_settlement_key: Some(deterministic_privkey(seed, 11)),
                local_settlement_key_pubkey: None,
                ...
                remote_settlement_data: SettlementData {
                    ...
                    tlcs: vec![SettlementTlc {
                        ...
                        local_key: Some(deterministic_privkey(seed, 21)),
