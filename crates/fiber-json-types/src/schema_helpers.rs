...
pub fn schema_as_string_array(generator: &mut SchemaGenerator) -> Schema {
...
pub fn schema_as_string_optional(generator: &mut SchemaGenerator) -> Schema {
...
pub fn schema_as_integer(_generator: &mut SchemaGenerator) -> Schema {
    json_schema!({
        "type": "integer"
    })
}
...
pub fn schema_as_hex_bytes_optional(generator: &mut SchemaGenerator) -> Schema {
...
pub fn schema_as_uint_hex(generator: &mut SchemaGenerator) -> Schema {
    let mut schema = String::json_schema(generator);
    schema.insert("pattern".into(), "^0x(0|[1-9a-fA-F][0-9a-fA-F]*)$".into());
    schema
}

pub fn schema_as_uint_hex_optional(generator: &mut SchemaGenerator) -> Schema {
