/// StoreSample implementation for v0.6.1 `ChannelActorState`.
///
/// Provides deterministic sample instances for migration testing.
/// These samples represent the v0.6.1 serialization format.
...
impl ChannelActorState {
    /// Sample 0: Minimal state — all Option fields are None, all collections empty.
    fn sample_minimal(seed: u64) -> Self {
        ...
        ChannelActorState {
            ...
            is_acceptor: false,
            // NOTE: v0.6.1 does NOT have is_one_way
            to_local_amount: 0,
            to_remote_amount: 0,
    ...
    /// Sample 1: Fully populated state — every Option field is Some, collections non-empty.
    fn sample_full(seed: u64) -> Self {
        ...
        // --- TlcState: v0.6.1 TlcInfo does NOT have is_trampoline_hop ---
        ...
        // --- RetryableTlcOperations ---
        // v0.6.1 AddTlcCommand does NOT have is_trampoline_hop
        // v0.6.1 PrevTlcInfo does NOT have shared_secret
        let retryable_ops = VecDeque::from(vec![
            ...
            RetryableTlcOperation::AddTlc(AddTlcCommand {
                ...
                previous_tlc: Some(PrevTlcInfo::new(deterministic_hash256(seed, 354), 5, 1000)),
            }),
        ]);

        // --- waiting_forward_tlc_tasks: use single entry for determinism ---
