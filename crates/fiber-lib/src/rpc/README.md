...
<a id="liquidity-quote_loop_in"></a>
...
* `quote_id` - <em>[Hash256](#type-hash256)</em>, Provider-generated quote identifier.
* `funding_tx` - <em>`String`</em>, Funding transaction hash or wallet funding descriptor.
